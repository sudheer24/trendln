...
def datefmt(xdate, cal=None):
    ...
    class IndianTradingCalendar(AbstractHolidayCalendar):
        rules = [
            Holiday("Republic Day", month=1, day=26, year=2018),
            Holiday("Mahashivratri", month=2, day=13, year=2018),
            Holiday("Chatrapati Shivaji Jayanti", month=2, day=19, year=2018),
            Holiday("Holi", month=3, day=2, year=2018),
            Holiday("Mahavir Jayanti", month=3, day=29, year=2018),
            Holiday("Good Friday", month=3, day=30, year=2018),
            Holiday("Annual Bank Closing", month=4, day=2, year=2018),
            Holiday("Buddha Pournima", month=4, day=30, year=2018),
            Holiday("Maharashtra Day", month=5, day=1, year=2018),
            Holiday("Independence Day", month=8, day=15, year=2018),
            Holiday("Parsi New Year", month=8, day=17, year=2018),
            Holiday("Goat ID", month=8, day=22, year=2018),
            Holiday("Ganesh Chaturthi", month=9, day=13, year=2018),
            Holiday("Moharram", month=9, day=20, year=2018),
            Holiday("Mahatma Gandhi's Birthday", month=10, day=2, year=2018),
            Holiday("Dasera", month=10, day=18, year=2018),
            Holiday("Diwali-Balipratipada", month=11, day=8, year=2018),
            Holiday("Id-E-Milad", month=11, day=21, year=2018),
            Holiday("Guru Nanak Jayanti", month=11, day=23, year=2018),
            Holiday("Christmas", month=12, day=25, year=2018),
            Holiday("Republic Day", month=1, day=26, year=2019),
            Holiday("Maha Shivaratri", month=3, day=4, year=2019),
            Holiday("Holi", month=3, day=21, year=2019),
            Holiday("Ram Navami", month=4, day=13, year=2019),
            Holiday("Dr. Baba Saheb Ambedkar Jayanti", month=4, day=14, year=2019),
            Holiday("Mahavir Jayanti", month=4, day=17, year=2019),
            Holiday("Good Friday", month=4, day=19, year=2019),
            Holiday("Maharashtra Day", month=5, day=1, year=2019),
            Holiday("Id-ul-Fitr (Ramzan ID)", month=6, day=5, year=2019),
            Holiday("Bakri Id / Eid ul-Adha", month=8, day=12, year=2019),
            Holiday("Independence Day", month=8, day=15, year=2019),
            Holiday("Ganesh Chaturthi", month=9, day=2, year=2019),
            Holiday("Moharram", month=9, day=10, year=2019),
            Holiday("Mahatma Gandhi Jayanti", month=10, day=2, year=2019),
            Holiday("Dasara", month=10, day=8, year=2019),
            Holiday("Diwali-Laxmi Pujan", month=10, day=27, year=2019),
            Holiday("Guru Nanak Jayanti", month=11, day=12, year=2019),
            Holiday("Christmas", month=12, day=25, year=2019),
            Holiday("Republic Day", month=1, day=26, year=2020),
            Holiday("Maha Shivaratri", month=2, day=21, year=2020),
            Holiday("Mahavir Jayanti", month=4, day=6, year=2020),
            Holiday("Good Friday", month=4, day=10, year=2020),
            Holiday("Dr B.R. Ambedkar Jayanti", month=4, day=14, year=2020),
            Holiday("Buddha Purnima", month=5, day=7, year=2020),
            Holiday("Eid-al-Adha", month=7, day=31, year=2020),
            Holiday("Janmashtami", month=8, day=12, year=2020),
            Holiday("Independence Day", month=8, day=15, year=2020),
            Holiday("Muharram", month=8, day=29, year=2020),
            Holiday("Gandhi Jayanti", month=10, day=2, year=2020),
            Holiday("Vijaya Dashmi", month=10, day=25, year=2020),
            Holiday("Eid-e-Milad", month=10, day=29, year=2020),
            Holiday("Guru Nanak Jayanti", month=11, day=30, year=2020),
            Holiday("Christmas", month=12, day=25, year=2020),
            Holiday("New Year Day", month=1, day=1, year=2021),
            Holiday("Republic Day", month=1, day=26, year=2021),
            Holiday("Mahashivratri", month=3, day=11, year=2021),
            Holiday("Holi", month=3, day=29, year=2021),
            Holiday("Good Friday", month=4, day=2, year=2021),
            Holiday("Dr. Baba Saheb Ambedkar Jayanti", month=4, day=14, year=2021),
            Holiday("Ram Navami", month=4, day=21, year=2021),
            Holiday("Id-Ul-Fitr (Ramzan Id)", month=5, day=13, year=2021),
            Holiday("Bakri Id", month=7, day=21, year=2021),
            Holiday("Muharram", month=8, day=19, year=2021),
            Holiday("Ganesh Chaturthi", month=9, day=10, year=2021),
            Holiday("Dussehra", month=10, day=15, year=2021),
            Holiday("Diwali – Laxmi Pujan", month=11, day=4, year=2021),
            Holiday("Gurunanak Jayanti", month=11, day=19, year=2021),
            Holiday("Republic Day", month=1, day=26, year=2022),
            Holiday("Mahashivratri", month=3, day=1, year=2022),
            Holiday("Holi", month=3, day=18, year=2022),
            Holiday("Dr. Baba Saheb Ambedkar Jayanti / Mahavir Jayanti", month=4, day=14, year=2022),
            Holiday("Good Friday", month=4, day=15, year=2022),
            Holiday("Id-Ul-Fitr (Ramzan ID)", month=5, day=3, year=2022),
            Holiday("Moharram", month=8, day=9, year=2022),
            Holiday("Independence Day", month=8, day=15, year=2022),
            Holiday("Ganesh Chaturthi", month=8, day=31, year=2022),
            Holiday("Dussehra", month=10, day=5, year=2022),
            Holiday("Diwali-Balipratipada", month=10, day=26, year=2022),
            Holiday("Gurunanak Jayanti", month=11, day=8, year=2022),
            Holiday("Republic Day", month=1, day=26, year=2023),
            Holiday("Holi", month=3, day=7, year=2023),
            Holiday("Gudhipadwa", month=3, day=22, year=2023),
            Holiday("Ram Navami", month=3, day=30, year=2023),
            Holiday("Mahavir Jayanti", month=4, day=4, year=2023),
            Holiday("Good Friday", month=4, day=7, year=2023),
            Holiday("Dr. Baba Saheb Ambedkar Jayanti", month=4, day=14, year=2023),
            Holiday("Maharashtra Day", month=5, day=1, year=2023),
            Holiday("Buddha Pournima", month=5, day=5, year=2023),
            Holiday("Bakri Id", month=6, day=29, year=2023),
            Holiday("Independence Day", month=8, day=15, year=2023),
            Holiday("Parsi New Year", month=8, day=16, year=2023),
            Holiday("Ganesh Chaturthi", month=9, day=19, year=2023),
            Holiday("Id-E-Milad", month=9, day=28, year=2023),
            Holiday("Mahatma Gandhi Jayanti", month=10, day=2, year=2023),
            Holiday("Dussehra", month=10, day=24, year=2023),
            Holiday("Diwali Balipratipada", month=11, day=14, year=2023),
            Holiday("Gurunanak Jayanti", month=11, day=27, year=2023),
            Holiday("Christmas", month=12, day=25, year=2023),
            Holiday("Special Holiday", month=1, day=22, year=2024),
            Holiday("Republic Day", month=1, day=26, year=2024),
            Holiday("Maha Shivaratri", month=3, day=8, year=2024),
            Holiday("Holi", month=3, day=25, year=2024),
            Holiday("Good Friday", month=3, day=29, year=2024),
            Holiday("Eid-Ul-Fitr (Ramzan Eid)", month=4, day=11, year=2024),
            Holiday("Ram Navami", month=4, day=17, year=2024),
            Holiday("Maharashtra Day", month=5, day=1, year=2024),
            Holiday("Bakri Eid", month=6, day=17, year=2024),
            Holiday("Moharram", month=7, day=17, year=2024),
            Holiday("Independence Day", month=8, day=15, year=2024),
            Holiday("Mahatma Gandhi Jayanti", month=10, day=2, year=2024),
            Holiday("Diwali-Laxmi Pujan", month=11, day=1, year=2024),
            Holiday("Gurunanak Jayanti", month=11, day=15, year=2024),
            Holiday("Maharashtra Assembly Elections", month=11, day=20, year=2024),
            Holiday("Christmas", month=12, day=25, year=2024),
            Holiday("Mahashivratri", month=2, day=26, year=2025),
            Holiday("Holi", month=3, day=14, year=2025),
            Holiday("Id-Ul-Fitr (Ramadan Eid)", month=3, day=31, year=2025),
            Holiday("Shri Mahavir Jayanti", month=4, day=10, year=2025),
            Holiday("Dr. Baba Saheb Ambedkar Jayanti", month=4, day=14, year=2025),
            Holiday("Good Friday", month=4, day=18, year=2025),
            Holiday("Maharashtra Day", month=5, day=1, year=2025),
            Holiday("Independence Day / Parsi New Year", month=8, day=15, year=2025),
            Holiday("Shri Ganesh Chaturthi", month=8, day=27, year=2025),
            Holiday("Mahatma Gandhi Jayanti / Dussehra", month=10, day=2, year=2025),
            Holiday("Balipratipada", month=10, day=22, year=2025),
            Holiday("Prakash Gurpurb Sri Guru Nanak Dev", month=11, day=5, year=2025),
            Holiday("Christmas", month=12, day=25, year=2025)
        ]
    if cal == None: cal = IndianTradingCalendar()
    def mydate(x,pos):
        #print((x,pos))
        val = int(x + 0.5)
